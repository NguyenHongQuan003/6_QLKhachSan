...
public class Bus_Phong implements I_Phong{
	...
	public ArrayList<Phong> getPhongTheoTenPhong(String tenPh) {
		return dao_phong.getPhongTheoTenPhong(tenPh);
	}
	@Override
	public ArrayList<Phong> getPhongTheoLoaiPhong(String ten) {
		return dao_phong.getPhongTheoLoaiPhong(ten);
	}
	public ArrayList<Phong> getPhongTheoTienPhong(float tienPh) {
		return dao_phong.getPhongTheoTienPhong(tienPh);
	}
